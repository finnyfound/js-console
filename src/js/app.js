class JSConsoleApp {
  ...
  async initializeApp() {
    ...
    // Initial render for HTML/CSS content if needed
    this.render();
  }
      ...
      require(["vs/editor/editor.main"], () => {
        ...
        this.editor = monaco.editor.create(
          document.getElementById("monaco-editor"),
          {
            ...
            fontSize: 14,
            fontFamily:
              "Urbanist, 'Courier New', 'Consolas', Monaco, 'Liberation Mono', monospace",
  ...
  switchToLanguageTab(language) {
    ...
    this.renderInitialContent(language);
  }

  renderInitialContent(language) {
